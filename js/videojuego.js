...
var game = (function () {
    ...
    var canvas,
        ...
        buffer, //dimencion del juego

        bufferctx,

        player,//jugador principal

        evil,//personajes malos

        playerShot,//disparios de el personaje bueno

        fondoprincipal,// fonde de juego

        fondojefe,// fondo de juego

        evilSpeed = 1,//velocidad de dispario
    ...
    function preloadImages () {
        ...
        fondoprincipal = new Image();//imagen fonde juego

        fondoprincipal.src = 'images/fondovertical.png';

        fondojefe = new Image();

        fondojefe.src = 'images/fondovertical_jefe.png';
    ...
    function showLifeAndScore () {
        ...
        bufferctx.fillStyle="rgb(241,245,8)";
    ...
    function showCongratulations () {
        ...
        bufferctx.fillStyle="rgb(177,184,184)";

        bufferctx.font="bold 22px Arial";

        bufferctx.fillText("¡Felicidades!, ¡haz terminado el Batijuego!", canvas.width / 2 - 200, canvas.height / 2 - 30);

        bufferctx.fillText("PUNTOS: " + player.score, canvas.width / 2 - 200, canvas.height / 2);

        bufferctx.fillText("VIDAS: " + player.life + " vidas de 3", canvas.width / 2 - 200, canvas.height / 2 + 30);
